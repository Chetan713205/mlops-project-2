...
class ModelTraining:
    def __init__(self, data_path):
        ...
        self.experiment = comet_ml.Experiment(
            api_key = "n5kYeZ39Fy0Gh543KB50jKc4a",
            project_name = "mlops-project-2",
            workspace = "chetan713205"
            
        )
        logger.info("Model Training and Coment_ML initialized")
    ...
    def train_model(self):
        try:
            ...
            model_checkpoint = ModelCheckpoint(CHECKPOINT_FILE_PATH, monitor='val_loss', save_best_only=True, save_weights_only=True, mode='min', verbose=1)
            ...
            self.save_model_weights(model)                            # From below method
        except Exception as e:
            logger.error(str(e))
    ...
    def extract_weights(self, layer_name, model):
        try:
            ...
            logger.info(f"Extracting weights for the {layer_name}")
            return weights 
        except Exception as e:
            logger.error(str(e))
            raise CustomException("Error durning weight extraction", e)
    ...
    def save_model_weights(self, model):
        try:
            ...
            logger.error(str(e))
            raise CustomException("Error occured during weight saving process")            
